 ...
 * ~ Fixed Issue 1031: http://robocaml.codeplex.com/workitem/1031
	~ Thx for the feedback ravensorb!	http://robocaml.codeplex.com/workitem/1031
 */
var roboCAML = (function( $ ) {
	...
	return {
		...
		GetList: GetList, //function defined above. Retrofitted to expose as public method.
		...
		/*
			{
				webURL: specify the web you want to query,
				listName: specify the list you'd like to build CAML for.
				closeCaml: Accepts "SPServices" or "ClientOM" as valid options.
				ViewFields: Accepts an array of static names.
				OrderBy: http://robocaml.codeplex.com/wikipage?title=OrderBy 
				QueryOptions: http://robocaml.codeplex.com/wikipage?title=QueryOptions
				config: http://robocaml.codeplex.com/wikipage?title=Array%20of%20Objects
				camlFragment: Used to build nested queries.  Warning: Nested queries will cause hair loss.
				nestedQuery: internal usage only.
			}
		*/
			var prop,
			...
			var columnTypes = listProperties[ opt.listName ] = GetList( opt, true );
